...
int List::Amount()//cколько на данный момент в списке
{
	int amount = 1;
	Node *temp = Head;
	while (temp != Tail)
...
long List::CountAmount()//сумма всех что в списке
{
	Node *temp = Head;
